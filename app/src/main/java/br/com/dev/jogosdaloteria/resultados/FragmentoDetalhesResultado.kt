...
import br.com.dev.jogosdaloteria.modelos.*
...
class FragmentoDetalhesResultado : Fragment() {
    ...
    private fun carregarFragmentos() {
        ...
        fragmentTransaction.replace(R.id.container_frag_detalhes_principais,
            FragmentoResultadoInfoPrincipais.newInstance(
                numeroConcurso,
                tipoJogo
            )
        )
